...
public class QuadraticProbingHashTable<Integer> {
    ...
    public void insert(Integer x) {
        ...
        array[currentPos] = new HashEntry<Integer>(x, true);
     ...
     */
    private void rehash() {
        HashEntry<Integer>[] oldArray = array;
    ...
    private int myhash(Integer x) {
        // TODO create real hash code
        int hashVal = (int)x % 13;
    ...
    private HashEntry<Integer>[] array; // The array of elements
